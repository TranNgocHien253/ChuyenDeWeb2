...
<div x-cloak :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'" class="fixed inset-y-0 left-0 z-30 w-64 h-full overflow-y-auto transition duration-300 transform bg-white lg:translate-x-0 lg:static lg:inset-0">
    ...
    <nav class="mt-10">
        <a class="flex items-center px-6 py-2 mt-4 text-purple-600 bg-white bg-opacity-25" href="/">
        ...
        <a class="flex items-center px-6 py-2 mt-4 text-gray-500 hover:bg-gray-100 hover:bg-opacity-25 hover:text-gray-100" href="/ui-elements">
            <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
